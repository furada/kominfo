...
<div class='article-photo'> <span class='image-hover'> <span class='drop-icons'> <span class='icon-block'>
  ...
  <p>$isi ..</p></div>
   <div class='article-links'><a href='#' class='article-icon-link'><span class='icon-text'></span>dibaca: $baca</a> <a href='#' class='article-icon-link'><span class='icon-text'></span>Read Full Article</a> </div></div>
   ";}
  ?>
...
while($p2=mysql_fetch_array($populer2)){
  ...
  $isi2 = substr($isi_artikel2,0,strrpos($isi2," "));                        
                        ...
                        <ul class="article-array content-category">
                                        ...
                                        <li> <a href="#"><?php echo $p2[judul]; ?></a></li>
                      ...
                      <div class="panel">
					    <h3 style="background:#f07f07;">Link Terkait</h3>
					    <div><!-- BEGIN .article-side-block --><!-- BEGIN .article-array -->
					      <ul class="article-array content-category">
					        <li> <a href="http://lpse.sumutprov.go.id/" target="_blank">LPSE</a></li>
					        <li> <a href="http://kip.sumutprov.go.id/" target="_blank">Komisi Informasi</a></li>
					        <li> <a href="http://www.sumutprov.go.id/" target="_blank">Sumut Prov</a></li>
					        <li> <a href="http://www.kominfo.go.id" target="_blank">Kemkominfo</a></li>
					        <!-- END .article-array -->
				          </ul>
				        </div>
					    <!-- END .panel -->
