  ...
  <!--================= DOWNLOAD AREA ========================-->
  <div class="widget clearfix">
  <h3 class="widget-title">DOWNLOAD AREA</h3>
  <ul class="bullet-list">
  
  <?php
  $kategoridownload=mysql_query("select nama_kategoridownload, kategoridownload.id_kategoridownload, kategoridownload_seo,  
                         count(download.id_kategoridownload) as jml 
                         from kategoridownload left join download
                         on download.id_kategoridownload=kategoridownload.id_kategoridownload 
                         group by nama_kategoridownload
						 order by id_kategoridownload
						 DESC LIMIT 8");
						 
  while($k=mysql_fetch_array($kategoridownload)){
  
  echo "
  <li>
  <a href='kategoridownload-$k[id_kategoridownload]-$k[kategoridownload_seo].html'>$k[nama_kategoridownload]</a>
  <span class style=\"color:#fc7100;float:right;\">($k[jml])</span>
  </li>";}
  ?>
  <a href="download.html">Download lainnya</a>
