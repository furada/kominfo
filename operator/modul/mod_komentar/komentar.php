...
session_start();
 if (empty($_SESSION['username']) AND empty($_SESSION['passuser'])){  
  ...
  <strong>Anda berhasil</strong> menambahkan Komentar artikel.
  </div>";}
  ...
  <button data-dismiss='alert' class='close' type='button'>x</button>
  <strong>Anda berhasil</strong> meng-update Komentar artikel.
  </div>";}
  ...
  <button data-dismiss='alert' class='close' type='button'>x</button>
  <strong>Anda berhasil</strong> menghapus Komentar artikel.
  </div>";}
  ...
  $tampil=mysql_query("SELECT * FROM artikel,komentar 
  ...
  <td><a href='../artikel-$r[id_artikel]-$r[judul_seo].html#$r[id_komentar]'target='blank'>
  ...
  <img src='img/edit.png' class='ttLT'' title='Baca Komentar'></center></a>
  </td>
  ...
  <td><a href='../artikel-$r[id_artikel]-$r[judul_seo].html#$r[id_komentar]'target='blank'>$r[isi_komentar]</a></td>
  <td>$tgl</td>
  ...
  mysql_query("UPDATE komentar SET dibaca='Y' WHERE id_komentar='$_GET[id]'");
