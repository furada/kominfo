...
session_start();
 if (empty($_SESSION['username']) AND empty($_SESSION['passuser'])){  
  ...
  <ul class='dd-list'>
  <li><a href='?module=galerifoto&act=tambahgalerifoto'><span class='isw-plus'></span> Tambahkan Foto</a></li>
  ...
  <img src='../img_galeri/kecil_$r[gbr_gallery]' width=50 class='ttLT'' title='Perbesar Gambar'></a>
  </center></td>
  ...
  $edit = mysql_query("SELECT * FROM gallery WHERE id_gallery='$_GET[id]' AND username='$_SESSION[namauser]'");}
  ...
  <a class='fancybox' rel='group' href='../img_galeri/$r[gbr_gallery]'>
  <img src='../img_galeri/kecil_$r[gbr_gallery]' width=200 class='ttLT'' title='Perbesar Gambar'></a></div>
  <div class='clear'></div>
  </div>";}
