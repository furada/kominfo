...
session_start();
  ...
  <center><img src='img/edit.png' class='ttLT'' title='Edit Video'></center></a>
  </td>
   
  <td width='8%'>
  <a href=javascript:confirmdelete('$aksi?module=video&act=hapus&id=$r[id_video]&namafile=$r[gbr_video]') >
  <center><img src='img/hapus.png' class='ttLT'' title='Hapus Video'></center></a> 
  </td>
  ...
  <img src='../img_video/kecil_$r[gbr_video]' width=200 class='ttLT'' title='Perbesar Gambar'></a>
