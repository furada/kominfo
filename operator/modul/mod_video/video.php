...
//  $tampil = mysql_query("SELECT * FROM video,playlist WHERE (video.id_playlist=playlist.id_playlist) 
 // AND (username='$_SESSION[namauser]')  ORDER BY id_video DESC");}
  ...
  $tampil = mysql_query("SELECT * FROM video WHERE   
   (username='$_SESSION[namauser]')  ORDER BY id_video DESC");}
  
  $no = $posisi+1;
  while($r=mysql_fetch_array($tampil)){
  $tgl_posting=tgl_indo($r[tanggal]);
	
$wilayah= $r['id_playlist'];
$sql3="select * from playlist where id_playlist='$wilayah'";
...
<td>$r[username]</td>
  ...
  <div class='row-form'>
  <div class='span3'><b>1. Input dengan Link Youtube</b></div>
  <div class='span9'>
  <input type=text name='youtube'>
  <p class style=\"color:#245689;font-size:12px;margin-bottom:-5px;\">
  contoh: http://www.youtube.com/watch?v=ldHd8Z5ZV-c</span></p></div>
  <div class='clear'></div>
  </div>    
						  			
  <div class='row-form'>
  <div class='span3'><b>2. Input dengan Video File</b></div>
  ...
  <div class='notes'>Pilih salah satu input video:<br>
  &bull; 1. Input dengan Link URL Youtube.<br> &bull; 2. Input dengan File Video dari komputer Anda. </div> ";
  ...
  <div class='row-form'>
  <div class='span3'><b>1. Ganti Link Youtube</b></div>
  <div class='span9'>
  <input type=text name='youtube' value='$r[youtube]'></div>
  <div class='clear'></div>
  </div>";
  
  echo "
  <div class='row-form'>
  <div class='span3'><b>2. Ganti File Video</b></div>
  <div class='span9'><input type=file name='fupload2'>
  <p class style=\"color:#245689;font-size:12px;margin-bottom:-5px;\">Tipe video harus MP4/FLV
  </p></div>
  <div class='clear'></div>
