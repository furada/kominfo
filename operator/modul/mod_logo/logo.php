...
session_start();
 if (empty($_SESSION['username']) AND empty($_SESSION['passuser'])){  
  ...
  <img width='200' src='../img_logo/$r[gambar]' class='ttLT'' title='Perbesar Gambar'></a>
  </td>
  
  <td width='8%'>
  <a href=?module=logo&act=editlogo&id=$r[id_logo] ><center>
  <img src='img/edit.png' class='ttLT'' title='Edit Logo'></center></a>
  </td>
  ...
  <div class='span9'>
  <a class='fancybox' rel='group' href='../img_logo/$r[gambar]'>
  <img src='../img_logo/$r[gambar]' width=200 class='ttLT'' title='Perbesar Gambar'></a>
  </div>
  <div class='clear'></div>
  </div>   
