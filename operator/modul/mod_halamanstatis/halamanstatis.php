...
session_start();
 if (empty($_SESSION['username']) AND empty($_SESSION['passuser'])){  
  ...
  <td>$r[judul]</td> 
  <td><a href='../hal-$r[judul_seo].html' target='_blank'>hal-$r[judul_seo].html</a></td>
  <td>$r[username]</td>
  <td width='8%'>
  ...
  if ($_SESSION[leveluser]=='admin'){
  $tampil = mysql_query("SELECT * FROM halamanstatis WHERE judul LIKE '%$_GET[kata]%' 
  ...
  <img src='../img_statis/$r[gambar]' width=200 class='ttLT'' title='Perbesar Gambar'></a></div>
  <div class='clear'></div>
  </div>    
