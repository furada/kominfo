...
session_start();
 if (empty($_SESSION['username']) AND empty($_SESSION['passuser'])){  
  ...
  <h1>IKLAN POP UP ~ Ukuran 512 x 384</h1>  
  ...
  $tampil = mysql_query("SELECT * FROM iklan_popup ORDER BY id_iklan_popup DESC");}
  
  else{
  $tampil=mysql_query("SELECT * FROM iklan_popup
  ...
  <embed src='../img_popup/$r[gambar]' height=60 class='ttLT'' title='Perbesar Gambar'></embed></a>
  </td>
  ...
  <center><img src='img/hapus.png' class='ttLT'' title='Hapus Iklan'></center></a> 
  </td>
  ...
  $edit = mysql_query("SELECT * FROM iklan_popup WHERE id_iklan_popup='$_GET[id]'");
