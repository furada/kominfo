...
session_start();
 if (empty($_SESSION['username']) AND empty($_SESSION['passuser'])){  
  ...
  <td width='8%'>
  <a href=?module=tag&act=edittag&id=$r[id_tag]><center><img src='img/edit.png' class='ttLT' title='Edit Tag Blog'></center></a>
  </td>
   
  <td width='8%'>
  <a href=javascript:confirmdelete('$aksi?module=tag&act=hapus&id=$r[id_tag]') >
  <center><img src='img/hapus.png' class='ttLT'' title='Hapus Tag Blog'></center></a> 
  </td>
