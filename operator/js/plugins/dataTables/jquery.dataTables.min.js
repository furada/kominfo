...
this._iDisplayStart + this.aiDisplay.length : Math.min(this._iDisplayStart + this._iDisplayLength, this._iRecordsDisplay) : this._iDisplayEnd
                ...
                sLengthMenu: "Tampil _MENU_ data", sZeroRecords: "Data yang dicari tidak cocok.", sEmptyTable: "Tidak ada data.", sInfo: "Tampil _START_ sampai _END_ dari _TOTAL_ data", sInfoEmpty: "Tampilkan 0 sampai 0 dari 0 data", sInfoFiltered: "(Seleksi dari _MAX_ total data)", sInfoPostFix: "", sSearch: "Cari:", sUrl: "", oPaginate: { sFirst: "Awal", sPrevious: "Kembali", sNext: "Lanjut", sLast: "Akhir" }, fnInfoCallback: null
